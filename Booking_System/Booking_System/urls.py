...
urlpatterns = [
    ...
    path("dashboard/'<int:id>'", views.customerdashboard),
    path("customer_edit/<int:id>/", views.customer_edit, name="customeredit"),
    path("customer_update/<int:id>", views.customer_update, name="customerupdate"),
    ...
    path('loginValidate/', views.loginValidate, name="customerlogin"),
    ...
    path('adminpage/room_update/<int:id>/', views.room_update, name='room_finally_update'),
